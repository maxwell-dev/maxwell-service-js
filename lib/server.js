...
class Server {
    ...
    start() {
        const master = new internal_1.Master(this._options.master_endpoints, new maxwell_utils_1.Options());
        const registerReq = new maxwell_protocol_1.msg_types.register_server_req_t({
