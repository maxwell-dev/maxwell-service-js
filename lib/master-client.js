...
class MasterClient {
    ...
    request(msg) {
        return this._connection
            .waitOpen(this._options.masterClientOptions.connectionOptions.waitOpenTimeout)
            .then((connection) => {
            return connection
                .request(msg, this._options.masterClientOptions.connectionOptions.roundTimeout)
                .then((result) => result);
        });
    }
    _pickEndpoint() {
