...
function buildPublisherOptions(options) {
    ...
    return {
        ...
        maxConsecutiveDisconnectedTimes: options.maxConsecutiveDisconnectedTimes ?? 5,
        connectionPoolOptions: (0, maxwell_utils_1.buildConnectionPoolOptions)(options.connectionPoolOptions),
    };
}
